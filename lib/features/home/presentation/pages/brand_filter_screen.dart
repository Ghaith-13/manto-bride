...
class BrandFilterScreen extends StatefulWidget {
  ...
  const BrandFilterScreen({Key? key, required this.categoryId})
      : super(key: key);
...
class _ContactsPageState extends State<BrandFilterScreen> {
  ...
  Widget build(BuildContext context) {
    if (dofunction == 0) {
      final state = context.select((HomeCubit myCubit) => myCubit.state);
                ...
                child: BlocBuilder<HomeCubit, HomeState>(
                  builder: (context, state) {
                    return ElevatedButton(
                      ...
                      style: ButtonStyle(
                          backgroundColor:
                              WidgetStatePropertyAll(AppColors.buttonColors)),
                    );
                  },
                ),
              )
      ...
      body: AzListView(
        ...
        indexBarOptions: IndexBarOptions(
          ...
          downItemDecoration: const BoxDecoration(
              shape: BoxShape.circle, color: AppColors.buttonColors),
          indexHintWidth: 120 / 2,
          indexHintHeight: 100 / 2,
          indexHintDecoration: BoxDecoration(color: AppColors.buttonColors),
