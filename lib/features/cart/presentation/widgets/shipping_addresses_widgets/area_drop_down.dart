...
class AreaDropDown extends StatefulWidget {
  ...
  @override
  State<AreaDropDown> createState() => _ColorDropDownState();
}

class _ColorDropDownState extends State<AreaDropDown> {
  @override
                            ...
                            return DropdownButtonHideUnderline(
                              child: DropdownButton2<String>(
                                ...
                                items: state.areas
                                    ...
                                    .toList(),
                                onChanged: (value) {
                                  context.read<CartCubit>().changeareaName(
