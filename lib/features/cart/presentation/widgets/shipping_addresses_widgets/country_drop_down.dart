...
class CountryDropDown extends StatefulWidget {
  ...
  @override
  State<CountryDropDown> createState() => _ColorDropDownState();
}

class _ColorDropDownState extends State<CountryDropDown> {
  @override
                  ...
                  return DropdownButtonHideUnderline(
                    child: DropdownButton2<String>(
                      ...
                      items: state.countries
                          ?.map((Regions item) => DropdownMenuItem<String>(
                          ...
                          .toList(),
                      onChanged: (value) {
                        context.read<CartCubit>().changecountryName(
                        ...
                        context.read<CartCubit>().changeprovince(value!);
